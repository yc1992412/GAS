...
parser.add_argument("--n_sample_in", type=int, default=2960, help="内部点需要的总样本数")
parser.add_argument("--n_sample_bound", type=int, default=740, help="每条边上需要的样本数,n_sample_bound*4=n_sample_in/4")
