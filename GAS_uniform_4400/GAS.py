...
parser.add_argument("--n_sample_in", type=int, default=4400, help="内部点需要的总样本数")
parser.add_argument("--n_sample_bound", type=int, default=1100, help="每条边上需要的样本数,n_sample_bound*4=n_sample_in/4")
...
scheduler_P = torch.optim.lr_scheduler.MultiStepLR(optimizer_P, milestones = [500, 1000, 1500, 2000, 5000, 10000, 15000], gamma = 0.8)
