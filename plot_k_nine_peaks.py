...
## load data
xi_in_load = torch.load("./GAS_nine/data/xi_in.pt").cpu()
xi_bound_all = torch.load(f'./GAS_nine/data/xi_bound_add_all_{epoch}.pt')
xi_add_all = torch.load(f'./GAS_nine/data/xi_add_all_{epoch}.pt')
xi_bound_add_all = torch.load(f'./GAS_nine/data/xi_bound_add_all_{epoch}.pt')
...
u_exact_re = u_exact.reshape((opt.n_test, opt.n_test))
my_pinns = torch.load(f'./GAS_nine/saved_model/my_pinns_model_{epoch}_{epoch_P}')
